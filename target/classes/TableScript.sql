...
insert into admin(name,address,GSTIN, sac) values('S BAHETI & ASSOCIATES','Office No. A104, Royal Tranquil, Near Kokane Chowk, Rahatani, Pune-411017','GST1234', '123456789'); 
SELECT * FROM ADMIN;
...
insert into logindetails(id, username,password) values(1,'admin','admin');
